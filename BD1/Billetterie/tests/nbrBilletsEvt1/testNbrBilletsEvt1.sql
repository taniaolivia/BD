...
-- Fichier resultat : testNbrBilletsEvt1.out
-- ============================================================================
...
INSERT INTO BILLET(IDBILLET, CODEBILLET, IDEVT, IDCLI, IDTARIF, IDSITERESA)
VALUES(4, 'AD004', 2, 1, 1, NULL);
INSERT INTO BILLET(IDBILLET, CODEBILLET, IDEVT, IDCLI, IDTARIF, IDSITERESA)
VALUES(5, 'AD005', 2, 1, 1, NULL);
INSERT INTO BILLET(IDBILLET, CODEBILLET, IDEVT, IDCLI, IDTARIF, IDSITERESA)
...
PROMPT fichier resultat du test : nbrBilletsEvt1/testNbrBilletsEvt1.out 
...
@ nbrBilletsEvt1/nbrBilletsEvt1.sql
