-- ============================================================================
-- Fichier          : testClientMemeTourneeQueMartin.sql
-- Auteur           : Tania OLIVIA
-- Date             : 10 Decembre 2019
-- Base             : Surgeles
-- Role             : Le test pour afficher les clients livrés lors de la même tournée qui a permis de livrer la commande passée le 01/10/2013 par Jean MARTIN
-- Fichier resultat : testClientMemeTourneeQueMartin.out
-- ============================================================================
...
-- CAS1
--Cas 1 a la même tournée que Jean MARTIN
...
-- CAS2
--Cas 2 a la même tournée que Jean MARTIN
------- Le client de la commande
INSERT INTO CLIENT (IDCLI, NOMCLI, PRENOMCLI, TELCLI, MAILCLI, ADRCLI)
...
-- CAS4
--Cas 4 n'a pas la même tournée que Jean MARTIN
------- Le client de la commande
INSERT INTO CLIENT (IDCLI, NOMCLI, PRENOMCLI, TELCLI, MAILCLI, ADRCLI)
...
-- CAS5
--Cas 5 n'a pas la même tournée que Jean MARTIN
------ Le client de la commande
INSERT INTO CLIENT (IDCLI, NOMCLI, PRENOMCLI, TELCLI, MAILCLI, ADRCLI)
...
-- CAS6
--Cas 6 n'a pas la même tournée que Jean MARTIN
------ Le client de la commande
INSERT INTO CLIENT (IDCLI, NOMCLI, PRENOMCLI, TELCLI, MAILCLI, ADRCLI)
...
SPOOL testClientMemeTourneeQueMartin.out
PROMPT fichier resultat du test : testClientMemeTourneeQueMartin.out
...
SET echo ON
@clientMemeTourneeQueMartin.sql
SET echo OFF
