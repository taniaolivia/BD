-- ============================================================================
-- Fichier          : testCommandesAvecDessert.sql
-- Auteur           : Tania OLIVIA
-- Date             : 18 Novembre 2019
-- Base		        : Surgeles
-- Role             : le test pour les commandes avec dessert
-- Fichier resultat : testCommandesAvecDessert.out
-- ============================================================================
...
SPOOL testCommandesAvecDessert.out
PROMPT fichier resultat du test : testCommandesAvecDessert.out
...
PROMPT 'Resultat de la requete resans sous-requete'
SET echo ON
@commandesAvecDessertSansSR.sql
SET echo OFF

PROMPT 'Resultat de la requete avec Exists'
SET echo ON
@commandesAvecDessertExists.sql
SET echo OFF

PROMPT 'Resultat de la requete avec IN'
SET echo ON
@commandesAvecDessertIN.sql
SET echo OFF

PROMPT 'Resultat de la requete avec IN et une sous-requete correlee'
SET echo ON
@commandesAvecDessertINCorrelee.sql
SET echo OFF
