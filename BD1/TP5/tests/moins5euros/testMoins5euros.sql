...
------- La commande passée par le client
-- L'identifiant de commande est 2, MEME commande que pour la commande 1, donc on ne le recrée pas
INSERT INTO PRODUIT (IDPRO, NOMPRO, TYPEPRO)
VALUES (2, 'B', 'POISSON');
...
-- L'identifiant du produit est 1, MEME commande que pour la commande 1 de cas 1, donc on ne le recrée pas
INSERT INTO COMMANDE (IDCOM, IDCLI, DATECOM, DATERECEPPREVI)
