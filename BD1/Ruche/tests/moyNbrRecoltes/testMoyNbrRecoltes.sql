...
-- Base				: Ruche
-- Role             : Le test pur afficher une rêquete sur la moyenne de récoltes par rucher
...
-- CAS1
-- L’apiculteur 1 a un identifiant rucher 1 
------- L'apiculteur
...
-- CAS2
-- L’apiculteur 2 a un identifiant rucher 2
------- L'apiculteur
INSERT INTO APICULTEUR (IDAPI, NOMAPI, PRENOMAPI, TELAPI, MAILAPI, ADRAPI)
...
-- CAS4
-- L’apiculteur 3 a un identifiant rucher 1
------- L'apiculteur
INSERT INTO APICULTEUR (IDAPI, NOMAPI, PRENOMAPI, TELAPI, MAILAPI, ADRAPI)
...
-- CAS5
-- L’apiculteur 3 a un identifiant rucher 3
------- Le rucher
INSERT INTO RUCHER (IDRUCHER, TYPEMIEL)
VALUES(3, 'sapin');
------- La ruche
...
-- CAS6
-- L’apiculteur 3 a un identifiant rucher 4
------- Le rucher
INSERT INTO RUCHER (IDRUCHER, TYPEMIEL)
VALUES(4, 'thym');
------- La ruche
...
SPOOL moyNbrRecoltes/testMoyNbrRecoltes.out
PROMPT fichier resultat du test : moyNbrRecoltes/testMoyNbrRecoltes.out
...
SET echo ON
@moyNbrRecoltes/moyNbrRecoltes.sql
SET echo OFF
