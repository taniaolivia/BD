...
-- CAS1
-- L’identifiant de l’apiculteur 1 produise du miel de type « acacia »
------- L'apiculteur
...
-- CAS2
-- L’identifiant de l’apiculteur 3 produise du miel de type « acacia »
------- L'apiculteur
INSERT INTO APICULTEUR (IDAPI, NOMAPI, PRENOMAPI, TELAPI, MAILAPI, ADRAPI)
...
-- CAS3
-- L’identifiant de l’apiculteur 2 ne produise pas du miel de type « acacia » mais elle produise du miel de type « colza »
------- L'apiculteur
INSERT INTO APICULTEUR (IDAPI, NOMAPI, PRENOMAPI, TELAPI, MAILAPI, ADRAPI)
...
-- CAS5
-- L’identifiant de l’apiculteur 3 ne produise pas du miel de type « acacia » mais elle produise du miel de type « sapin»
------- Le rucher
INSERT INTO RUCHER (IDRUCHER, TYPEMIEL)
VALUES(3, 'sapin');
------- La ruche
...
-- CAS6
-- L’identifiant de l’apiculteur 2 ne produise pas du miel de type « acacia » mais elle produise du miel de type « thym »
------- Le rucher
INSERT INTO RUCHER (IDRUCHER, TYPEMIEL)
VALUES(4, 'thym');
------- La ruche
...
SPOOL apiculteurAcacia/testApiculteurAcacia.out
PROMPT fichier resultat du test : apiculteurAcacia/testApiculteurAcacia.out
...
SET echo ON
@apiculteurAcacia/apiculteurAcacia.sql
SET echo OFF
