-- ============================================================================
-- Fichier : testRelationContrat_DINV_ck_FINCONTRAT.sql 
-- Auteur  : Tania OLIVIA					
-- Date    : 09/02/2020							
-- Role    : tester les contraintes d'inegrite statiques definies sur la 
-- 	         relation contrat du check FINCONTRAT dans le domaine INVALIDE
-- Fichier resultat : testRelationContrat_DINV_ck_FINCONTRAT.out 
-- ============================================================================
...
spool testRelationContrat_DINV_ck_FINCONTRAT.out  
prompt fichier resultat du test : testRelationContrat_DINV_ck_FINCONTRAT.out
...
-- ============================================================================
-- Cas 1: 
-- Le date de début contrat est supérieur que la fin du contrat
-- ============================================================================
set echo off

-- Il ne va pas afficher ce cas parce qu'il existe une violation dans le check constrainte (FINCONTRAT)
INSERT INTO CONTRAT(NUMCONTRAT, DATESIGNATURE,DEBCONTRAT, FINCONTRAT,TYPECONTRAT,CONTRACTANT,EMPLACEMENT) 
VALUES (1, TO_DATE('10/02/2020','DD/MM/YYYY'), TO_DATE('12/12/2020','DD/MM/YYYY'), TO_DATE('18/11/2020','DD/MM/YYYY'), 'annuel', 1, 1) ;
