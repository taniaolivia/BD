-- ============================================================================
-- Fichier : testRelationContrat_DINV_ck_DEBCONTRAT.sql 
-- Auteur  : Tania OLIVIA					
-- Date    : 09/02/2020							
-- Role    : tester les contraintes d'inegrite statiques definies sur la 
-- 	         relation contrat du check DEBCONTRAT dans le domaine INVALIDE
-- Fichier resultat : testRelationContrat_DINV_ck_DEBCONTRAT.out 
-- ============================================================================
...
spool testRelationContrat_DINV_ck_DEBCONTRAT.out  
prompt fichier resultat du test : testRelationContrat_DINV_ck_DEBCONTRAT.out
...
-- ============================================================================
-- Cas 1: 
-- Le date de debut contrat est inférieur que la fin du contrat
-- ============================================================================
set echo off

--Il ne va pas afficher ce cas parce qu'il existe une violation dans le check constrainte (DEBCONTRAT)
INSERT INTO CONTRAT(NUMCONTRAT, DATESIGNATURE,DEBCONTRAT, FINCONTRAT,TYPECONTRAT,CONTRACTANT,EMPLACEMENT)
VALUES (1, TO_DATE('17/01/2021','DD/MM/YYYY'), TO_DATE('12/10/2020','DD/MM/YYYY'), NULL, 'annuel', 1, 1) ;
