-- ============================================================================
-- Fichier : testDELETE_vue_SORTIES_PREVUES.sql 
-- Auteur  : Tania OLIVIA					
-- Date    : 19/03/2020	
-- Role    : tester l'utilisation de la vue vue_SORTIES_PREVUES en Suppression
-- ============================================================================
...
--=============================================================================
SPOOL  testDELETE_vue_SORTIES_PREVUES.out
...
set echo on
-- ============================================================================
--  Tester DELETE d'un nuplet à travers la vue vue_SORTIES_PREVUES
-- ============================================================================
-- Contenu de la vue avant DELETE 
select CODPORT, NOMBAT, DATSORTPREV, DATRETPREV
from   vue_SORTIES_PREVUES;

-- DELETE d'un nuplet à travers la vue vue_SORTIES_PREVUES
delete from vue_SORTIES_PREVUES
