-- ============================================================================
-- Fichier : testINSERT_vue_SEJOUR_BATPASS.sql 
-- Auteur  : Tania OLIVIA					
-- Date    : 19/03/2020	
-- Role    : tester l'utilisation de la vue vue_SEJOUR_BATPASS en insertion
-- ============================================================================
...
--=============================================================================
SPOOL  testINSERT_vue_SEJOUR_BATPASS.out
...
set echo on
-- ============================================================================
--  Tester l'insertion d'un nuplet dans la vue vue_SEJOUR_BATPASS
-- ============================================================================
