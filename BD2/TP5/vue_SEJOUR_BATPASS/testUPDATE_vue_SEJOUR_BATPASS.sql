-- ============================================================================
-- Fichier : testUPDATE_vue_SEJOUR_BATPASS.sql 
-- Auteur  : Tania OLIVIA					
-- Date    : 19/03/2020
-- Role    : tester l'utilisation de la vue vue_SEJOUR_BATPASS en UPDATE
-- ============================================================================
...
--=============================================================================
SPOOL  testUPDATE_vue_SEJOUR_BATPASS.out
...
set echo on
-- ============================================================================
--  Tester UPDATE d'un nuplet à travers la vue vue_SEJOUR_BATPASS
-- ============================================================================
-- Contenu de la vue avant UPDATE 
select CODPORT, NOMBAT, NOMPROP, ADRESSE, NB_SEJOURS
from   vue_SEJOUR_BATPASS;

-- Update d'un nuplet à travers la vue vue_SEJOUR_BATPASS
