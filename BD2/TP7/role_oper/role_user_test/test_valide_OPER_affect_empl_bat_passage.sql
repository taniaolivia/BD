-- ============================================================================
-- Fichier : test_valide_OPER_affect_empl_bat_passage.sql 
-- Auteur  : Tania Olivia
-- Date    : 26 Mars 2020
...
-------------------------------------------------------------------------------
spool test_valide_OPER_affect_empl_bat_passage.out
...
INSERT INTO TOLIVIA.BATEAU_PASSAGE (ID_BATPASS, CODPORT, NOMBAT, ARV, DEPART, ID_MOD, 
NOMPROP, TEL_PORTABLE, ADRESSE, EMPL_AFF)
