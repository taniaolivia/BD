-- ============================================================================
-- Fichier : test_valide_OPER_sortie_bat_resident.sql 
-- Auteur  : Tania Olivia
-- Date    : 26 Mars 2020
...
-- Precondition : LOGIN : executer le jeu de test : jeu_test_affect_empl_bat_resident.sql 
-- ============================================================================
...
-------------------------------------------------------------------------------
spool test_valide_OPER_sortie_bat_resident.out
...
insert into TOLIVIA.sortie (codport, nombat, datsortprev, datsortrelle, datretprev, 
                            datretrelle, eff_prv)
values ('LR', 'MOMO', '10/01/2019', '10/01/2019', '20/01/2019', 
                    '20/01/2019','PRV') ;
