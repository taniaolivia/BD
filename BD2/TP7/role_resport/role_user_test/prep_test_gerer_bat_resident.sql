--==========================
--fichier           : prep_test_gerer_bat_resident.sql
--base              : Port de plaisance
--auteur(s)         : Tania OLIVIA
--date              : 31/03/2020
--role              : La préparation du test gerer bateau résident
--==========================
-- ============================================================================
...
--INSERTION DU EMPLACEMENT 2
INSERT  INTO EMPLACEMENT (ID_EMPL, BASSIN, PONTON, EMPLNO, TYPE_EMPL)
VALUES ('2', 'Gise', 'L', 2, 2);

--INSERTION DU EMPLACEMENT_LIBRE 2
INSERT  INTO EMPLACEMENT_LIBRE (ID_EMPL, DEB_LIBRE, FIN_LIBRE, TYPE_EMPL)
