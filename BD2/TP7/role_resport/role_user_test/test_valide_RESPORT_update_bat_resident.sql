-- ============================================================================
-- Fichier : test_valide_RESPORT_update_bat_resident.sql 
-- Auteur  : Tania Olivia
-- Date    : 26 Mars 2020
...
-------------------------------------------------------------------------------
spool test_valide_RESPORT_update_bat_resident.out
...
set echo on;
-------------------------------------------------------------------------------
--  Tester UPDATE d'un nuplet du BATEAU_RESIDENT
-------------------------------------------------------------------------------
-- Contenu avant UPDATE
select *
from  TOLIVIA.BATEAU_RESIDENT;

-- UPDATE d'un nuplet du BATEAU_RESIDENT
update TOLIVIA.BATEAU_RESIDENT
set NOMBAT = 'ROLLIE'
where CODPORT = 'LR'
and NOMBAT = 'PAPO';

-- Contenu apres UPDATE
select *
from   TOLIVIA.BATEAU_RESIDENT;
